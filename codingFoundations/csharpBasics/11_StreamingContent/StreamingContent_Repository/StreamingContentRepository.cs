...
public class StreamingContentRepository
{
   ...
   protected readonly List<StreamingContent> _contentDb = new List<StreamingContent>();
    ...
    {
        //Make sure that the content exists
    ...
    //todo return a List<StreamingContent> based on its MaturityRating
    public List<StreamingContent> GetContentByMaturityRating(MaturityRating rating)
    {
